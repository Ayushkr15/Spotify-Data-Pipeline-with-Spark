...
from datetime import datetime
from awsglue.dynamicframe import DynamicFrame
s3_path = "s3://spotify-etl-pipeline-spark-ayush/raw_data/to_processed/"
...
def write_to_s3(df, path_suffix, format_type="csv"):
    ...
    glueContext.write_dynamic_frame.from_options(
        frame=dynamic_frame,
        connection_type="s3",
        connection_options={"path": f"s3://spotify-etl-pipeline-spark-ayush/tranformed_data/{path_suffix}/"},
        format=format_type
    )
...
bucket_name = "spotify-etl-pipeline-spark-ayush"
